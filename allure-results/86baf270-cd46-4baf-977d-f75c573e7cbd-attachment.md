...
```
Error: expect: Property 'tocontain' not found.
```
    ...
    - list [ref=e66]:
      ...
      - listitem [ref=e72]:
        - link "Success" [ref=e73] [cursor=pointer]:
          - /url: http://localhost/opencart/index.php?route=account/success
    - generic [ref=e74]:
      - generic [ref=e75]:
      ...
      - complementary [ref=e84]:
        - generic [ref=e85]:
          ...
          - link "Edit Account" [ref=e87] [cursor=pointer]:
            - /url: http://localhost/opencart/index.php?route=account/edit
          - link "Password" [ref=e88] [cursor=pointer]:
            - /url: http://localhost/opencart/index.php?route=account/password
          ...
          - link "Logout" [ref=e98] [cursor=pointer]:
            - /url: http://localhost/opencart/index.php?route=account/logout
  - contentinfo [ref=e99]:
    - generic [ref=e100]:
      - generic [ref=e101]:
        - generic [ref=e102]:
...
```ts
  ...
  19 | await registrationPage.setFirstName(RandomDataGenerator.getFirstName())
  20 | await registrationPage.setLastName(RandomDataGenerator.getLastName())
  21 | await registrationPage.setEmail(RandomDataGenerator.getEmail())
  22 | await registrationPage.setPhone(RandomDataGenerator.getPhoneNumber())
  ...
  26 | await registrationPage.acceptPrivacyPolicy()
  27 | await registrationPage.clickContinue()         
  28 |     
  29 | // Validate the cofirmation message
