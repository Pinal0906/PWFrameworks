...
Call log:
  - waiting for locator('input[name=\'privacy\']')
          ...
          - group "Your Personal Details" [ref=e80]:
            ...
            - generic [ref=e90]:
              ...
              - textbox "* E-Mail" [ref=e93]:
                - /placeholder: E-Mail
                - text: Kevon_Konopelski0@gmail.com
            - generic [ref=e94]:
              - generic [ref=e95]: "* Telephone"
              - textbox "* Telephone" [ref=e97]:
                - /placeholder: Telephone
                - text: 1-794-688-7745 x22643
...
```ts
  ...
  30 |         this.privacyPolicyCheckbox = this.page.locator("input[name='privacy']")
  31 |         this.btnContinue = this.page.locator("button[type='submit']")
